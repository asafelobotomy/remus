...
- Write for a reader who has never seen this project before.
...
- For inventory-style documentation, prefer canonical references to `.copilot/workspace/workspace-index.json` over copying exhaustive file maps.
