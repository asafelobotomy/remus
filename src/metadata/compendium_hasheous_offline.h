...
namespace Compendium {
    ...
    bool loadHasheousOfflineIndex(const QString &dumpDir, QHash<QString, HasheousOfflineMatch> &indexByHash, QString &error);

    /// Lookup by normalized hash (any of crc32/md5/sha1/sha256 keys in @p indexByHash).
    bool lookupHasheousOfflineMatch(
        const QHash<QString, HasheousOfflineMatch> &indexByHash, const QString &crc32, const QString &md5,
        const QString &sha1, const QString &sha256, HasheousOfflineMatch &out);
