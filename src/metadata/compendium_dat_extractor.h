...
public:
    ...
    static QList<SourceRecordEnvelope> extract(const QString &filePath,
    ...
    static QString makeExternalKey(const QString &systemHint,
    ...
    static QString entryToPayloadJson(const QString &systemHint,
                                      const ClrMameProEntry &entry);
