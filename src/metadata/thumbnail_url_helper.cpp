...
QString ThumbnailUrlHelper::buildThumbnailUrl(const QString &systemName,
                                               ...
                                               const QString &type)
{
    ...
    const QString path = systemName + QLatin1Char('/') + type + QLatin1Char('/') + sanitized + QStringLiteral(".png");
...
QStringList ThumbnailUrlHelper::generateThumbnailCandidates(const QString &systemName,
                                                              const QString &gameName,
                                                              const QString &type)
{
