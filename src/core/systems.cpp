...
const QMap<int, SystemDef> SYSTEMS = {
    ...
    {ID_IBM_PC, {ID_IBM_PC, QStringLiteral("PC"), QStringLiteral("IBM PC Compatible"), QStringLiteral("IBM"), 5,
                 {QStringLiteral(".iso"), QStringLiteral(".img"), QStringLiteral(".bin"), QStringLiteral(".cue"), QStringLiteral(".chd"), QStringLiteral(".mdf")},
                 QStringLiteral("MD5"), {QStringLiteral("USA"), QStringLiteral("EUR"), QStringLiteral("JPN")}, true, QStringLiteral("#607d8b"), 1981}},
    {ID_PS4, {ID_PS4, QStringLiteral("PlayStation 4"), QStringLiteral("Sony PlayStation 4"), QStringLiteral("Sony"), 8,
              {QStringLiteral(".pkg"), QStringLiteral(".iso")},
              QStringLiteral("SHA1"), {QStringLiteral("USA"), QStringLiteral("JPN"), QStringLiteral("EUR")}, true, QStringLiteral("#003087"), 2013}},
    {ID_XBOX_ONE, {ID_XBOX_ONE, QStringLiteral("Xbox One"), QStringLiteral("Microsoft Xbox One"), QStringLiteral("Microsoft"), 8,
                   {QStringLiteral(".xvd"), QStringLiteral(".iso")},
                   QStringLiteral("SHA1"), {QStringLiteral("USA"), QStringLiteral("EUR"), QStringLiteral("JPN")}, true, QStringLiteral("#107c10"), 2013}},
    {ID_MAC, {ID_MAC, QStringLiteral("Mac"), QStringLiteral("Apple Macintosh"), QStringLiteral("Apple"), 3,
              {QStringLiteral(".toast"), QStringLiteral(".iso"), QStringLiteral(".img"), QStringLiteral(".bin"), QStringLiteral(".cue"), QStringLiteral(".chd")},
              QStringLiteral("MD5"), {QStringLiteral("USA"), QStringLiteral("EUR"), QStringLiteral("JPN")}, true, QStringLiteral("#999999"), 1984}},
    {ID_FM_TOWNS, {ID_FM_TOWNS, QStringLiteral("FM Towns"), QStringLiteral("Fujitsu FM Towns"), QStringLiteral("Fujitsu"), 4,
                   {QStringLiteral(".iso"), QStringLiteral(".bin"), QStringLiteral(".cue"), QStringLiteral(".chd"), QStringLiteral(".img")},
                   QStringLiteral("MD5"), {QStringLiteral("JPN")}, true, QStringLiteral("#c0392b"), 1989}},
    {ID_PC88, {ID_PC88, QStringLiteral("PC-88"), QStringLiteral("NEC PC-8801"), QStringLiteral("NEC"), 3,
    ...
    {ID_CDTV, {ID_CDTV, QStringLiteral("CDTV"), QStringLiteral("Commodore CDTV"), QStringLiteral("Commodore"), 4,
               {QStringLiteral(".iso"), QStringLiteral(".bin"), QStringLiteral(".cue"), QStringLiteral(".chd")},
               QStringLiteral("MD5"), {QStringLiteral("EUR"), QStringLiteral("USA")}, true, QStringLiteral("#8B4513"), 1991}},
    {ID_AMIGA_CD, {ID_AMIGA_CD, QStringLiteral("Amiga CD"), QStringLiteral("Amiga CD"), QStringLiteral("Commodore"), 4,
                   {QStringLiteral(".iso"), QStringLiteral(".bin"), QStringLiteral(".cue"), QStringLiteral(".chd")},
                   QStringLiteral("MD5"), {QStringLiteral("EUR"), QStringLiteral("USA")}, true, QStringLiteral("#e67e22"), 1993}},
    {ID_ARCHIMEDES, {ID_ARCHIMEDES, QStringLiteral("Archimedes"), QStringLiteral("Acorn Archimedes"), QStringLiteral("Acorn"), 4,
                     {QStringLiteral(".adf"), QStringLiteral(".iso"), QStringLiteral(".bin"), QStringLiteral(".cue"), QStringLiteral(".chd")},
                     QStringLiteral("MD5"), {QStringLiteral("EUR")}, true, QStringLiteral("#27ae60"), 1987}},
    {ID_TRIFORCE, {ID_TRIFORCE, QStringLiteral("Triforce"), QStringLiteral("Sega Triforce"), QStringLiteral("Sega"), 6,
                   {QStringLiteral(".iso"), QStringLiteral(".gcm")},
                   QStringLiteral("MD5"), {QStringLiteral("JPN"), QStringLiteral("USA"), QStringLiteral("EUR")}, false, QStringLiteral("#e74c3c"), 2002}},
    {ID_CHIHIRO, {ID_CHIHIRO, QStringLiteral("Chihiro"), QStringLiteral("Sega Chihiro"), QStringLiteral("Sega"), 6,
                  {QStringLiteral(".iso")},
                  QStringLiteral("MD5"), {QStringLiteral("JPN")}, false, QStringLiteral("#c0392b"), 2002}},
    {ID_TANDY_VIS, {ID_TANDY_VIS, QStringLiteral("VIS"), QStringLiteral("Tandy VIS"), QStringLiteral("Tandy"), 5,
                    {QStringLiteral(".iso"), QStringLiteral(".bin"), QStringLiteral(".cue")},
                    QStringLiteral("MD5"), {QStringLiteral("USA")}, true, QStringLiteral("#9b59b6"), 1992}},
    {ID_LINDBERGH, {ID_LINDBERGH, QStringLiteral("Lindbergh"), QStringLiteral("Sega Lindbergh"), QStringLiteral("Sega"), 7,
                    {QStringLiteral(".iso")},
                    QStringLiteral("MD5"), {QStringLiteral("JPN")}, false, QStringLiteral("#e74c3c"), 2005}},
    {ID_PALM_OS, {ID_PALM_OS, QStringLiteral("Palm OS"), QStringLiteral("Palm OS"), QStringLiteral("Palm"), 6,
                  {QStringLiteral(".pdb"), QStringLiteral(".prc"), QStringLiteral(".pqa")},
                  QStringLiteral("CRC32"), {QStringLiteral("USA")}, false, QStringLiteral("#f39c12"), 1996}},
    {ID_PLAYDIA, {ID_PLAYDIA, QStringLiteral("Playdia"), QStringLiteral("Bandai Playdia"), QStringLiteral("Bandai"), 5,
                  {QStringLiteral(".iso"), QStringLiteral(".bin"), QStringLiteral(".cue"), QStringLiteral(".chd")},
                  QStringLiteral("MD5"), {QStringLiteral("JPN")}, true, QStringLiteral("#3498db"), 1994}},
    {ID_APPLE_II, {ID_APPLE_II, QStringLiteral("Apple II"), QStringLiteral("Apple II / IIe / IIc / IIGS"), QStringLiteral("Apple"), 2,
                   {QStringLiteral(".do"), QStringLiteral(".po"), QStringLiteral(".2mg"), QStringLiteral(".nib"), QStringLiteral(".woz"), QStringLiteral(".dsk"), QStringLiteral(".hdv")},
                   QStringLiteral("CRC32"), {QStringLiteral("USA")}, false, QStringLiteral("#95a5a6"), 1977}},
    {ID_BBC_MICRO, {ID_BBC_MICRO, QStringLiteral("BBC Micro"), QStringLiteral("Acorn BBC Micro / Electron"), QStringLiteral("Acorn"), 3,
                    {QStringLiteral(".ssd"), QStringLiteral(".dsd"), QStringLiteral(".uef"), QStringLiteral(".bbc"), QStringLiteral(".adl")},
                    QStringLiteral("CRC32"), {QStringLiteral("EUR")}, false, QStringLiteral("#c0392b"), 1981}},
    {ID_C16, {ID_C16, QStringLiteral("Commodore 16"), QStringLiteral("Commodore 16 / Plus/4"), QStringLiteral("Commodore"), 3,
              {QStringLiteral(".d16"), QStringLiteral(".prg"), QStringLiteral(".tap"), QStringLiteral(".t64")},
              QStringLiteral("CRC32"), {QStringLiteral("EUR"), QStringLiteral("USA")}, false, QStringLiteral("#8B4513"), 1984}},
    {ID_MEGA_DUCK, {ID_MEGA_DUCK, QStringLiteral("Mega Duck"), QStringLiteral("Mega Duck / Cougar Boy"), QStringLiteral("Welback"), 4,
                    {QStringLiteral(".bin"), QStringLiteral(".md2")},
                    QStringLiteral("CRC32"), {QStringLiteral("EUR"), QStringLiteral("USA")}, false, QStringLiteral("#27ae60"), 1993}},
    {ID_MICROVISION, {ID_MICROVISION, QStringLiteral("Microvision"), QStringLiteral("Milton Bradley Microvision"), QStringLiteral("Milton Bradley"), 1,
                      {QStringLiteral(".bin"), QStringLiteral(".mvc")},
                      QStringLiteral("CRC32"), {QStringLiteral("USA")}, false, QStringLiteral("#95a5a6"), 1979}},
    {ID_NUON, {ID_NUON, QStringLiteral("Nuon"), QStringLiteral("VM Labs Nuon"), QStringLiteral("VM Labs"), 6,
               {QStringLiteral(".iso"), QStringLiteral(".bin"), QStringLiteral(".cue")},
               QStringLiteral("MD5"), {QStringLiteral("USA")}, true, QStringLiteral("#2c3e50"), 1999}},
};
...
const QMap<QString, QList<int>> EXTENSION_TO_SYSTEMS = {
    ...
    {QStringLiteral(".adf"), {ID_AMIGA, ID_ARCHIMEDES}}, {QStringLiteral(".adz"), {ID_AMIGA}}, {QStringLiteral(".dms"), {ID_AMIGA}}, {QStringLiteral(".ipf"), {ID_AMIGA}}, {QStringLiteral(".hdf"), {ID_AMIGA}},
    ...
    {QStringLiteral(".iso"), {ID_PSX, ID_PS2, ID_GAMECUBE, ID_WII, ID_PSP, ID_SATURN, ID_SEGA_CD, ID_DREAMCAST, ID_XBOX, ID_XBOX360, ID_3DO, ID_NEO_GEO_CD,
                   ID_IBM_PC, ID_PS4, ID_XBOX_ONE, ID_MAC, ID_FM_TOWNS, ID_CDTV, ID_AMIGA_CD, ID_ARCHIMEDES, ID_TRIFORCE, ID_CHIHIRO, ID_TANDY_VIS, ID_LINDBERGH, ID_PLAYDIA, ID_NUON}},
    ...
    {QStringLiteral(".bin"), {ID_PSX, ID_SATURN, ID_SEGA_CD, ID_TURBOGRAFX_CD, ID_ATARI_2600, ID_DREAMCAST, ID_PS2, ID_GENESIS, ID_3DO, ID_NEO_GEO_CD,
                   ID_IBM_PC, ID_FM_TOWNS, ID_CDTV, ID_AMIGA_CD, ID_TANDY_VIS, ID_PLAYDIA, ID_NUON, ID_MEGA_DUCK, ID_MICROVISION}},
    ...
    {QStringLiteral(".img"), {ID_PSX, ID_PS2, ID_SATURN, ID_IBM_PC, ID_MAC, ID_FM_TOWNS}}, {QStringLiteral(".m3u"), {ID_PSX, ID_PS2, ID_SATURN, ID_SEGA_CD, ID_DREAMCAST, ID_FM_TOWNS, ID_IBM_PC}},
    {QStringLiteral(".tap"), {ID_C64, ID_ZX_SPECTRUM}}, {QStringLiteral(".dsk"), {ID_ZX_SPECTRUM, ID_AMIGA, ID_AMSTRAD_CPC, ID_MSX, ID_MSX2, ID_SHARP_X1, ID_X68000, ID_VIDEOTON_TVC, ID_APPLE_II, ID_BBC_MICRO, ID_C16}}, {QStringLiteral(".elf"), {ID_PS2, ID_GAMECUBE, ID_WII}},
