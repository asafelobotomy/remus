...
const QMap<int, SystemDef> SYSTEMS = {
    ...
    {ID_VSMILE, {ID_VSMILE, QStringLiteral("V.Smile"), QStringLiteral("VTech V.Smile"), QStringLiteral("VTech"), 6,
                 {QStringLiteral(".bin"), QStringLiteral(".u1"), QStringLiteral(".u3")},
                 QStringLiteral("CRC32"), {QStringLiteral("USA"), QStringLiteral("EUR")}, false, QStringLiteral("#f39c12"), 2004}},
    {ID_LEAPSTER, {ID_LEAPSTER, QStringLiteral("Leapster"), QStringLiteral("LeapFrog Leapster"), QStringLiteral("LeapFrog"), 6,
                   {QStringLiteral(".bin"), QStringLiteral(".rom")},
                   QStringLiteral("CRC32"), {QStringLiteral("USA")}, false, QStringLiteral("#27ae60"), 2003}},
    {ID_LEAPPAD, {ID_LEAPPAD, QStringLiteral("LeapPad"), QStringLiteral("LeapFrog LeapPad"), QStringLiteral("LeapFrog"), 5,
                  {QStringLiteral(".bin"), QStringLiteral(".rom")},
                  QStringLiteral("CRC32"), {QStringLiteral("USA")}, false, QStringLiteral("#2ecc71"), 1999}},
    {ID_SEGA_BEENA, {ID_SEGA_BEENA, QStringLiteral("Beena"), QStringLiteral("Sega Beena"), QStringLiteral("Sega"), 7,
                     {QStringLiteral(".bin"), QStringLiteral(".md")},
                     QStringLiteral("CRC32"), {QStringLiteral("JPN")}, false, QStringLiteral("#1abc9c"), 2005}},
    {ID_CREATIVISION, {ID_CREATIVISION, QStringLiteral("CreatiVision"), QStringLiteral("VTech CreatiVision"), QStringLiteral("VTech"), 2,
                       {QStringLiteral(".bin"), QStringLiteral(".rom")},
                       QStringLiteral("CRC32"), {QStringLiteral("AUS"), QStringLiteral("EUR")}, false, QStringLiteral("#e74c3c"), 1981}},
    {ID_PICNO, {ID_PICNO, QStringLiteral("Picno"), QStringLiteral("Konami Picno"), QStringLiteral("Konami"), 4,
                {QStringLiteral(".bin"), QStringLiteral(".rom")},
                QStringLiteral("CRC32"), {QStringLiteral("JPN")}, false, QStringLiteral("#9b59b6"), 1993}},
    {ID_GAME_MASTER, {ID_GAME_MASTER, QStringLiteral("Game Master"), QStringLiteral("Hartung Game Master"), QStringLiteral("Hartung"), 4,
                      {QStringLiteral(".bin"), QStringLiteral(".rom")},
                      QStringLiteral("CRC32"), {QStringLiteral("EUR")}, false, QStringLiteral("#34495e"), 1990}},
    {ID_SYMBIAN, {ID_SYMBIAN, QStringLiteral("Symbian"), QStringLiteral("Mobile Symbian"), QStringLiteral("Nokia"), 7,
                  {QStringLiteral(".sis"), QStringLiteral(".sisx"), QStringLiteral(".app")},
                  QStringLiteral("CRC32"), {QStringLiteral("EUR"), QStringLiteral("USA")}, false, QStringLiteral("#bdc3c7"), 2000}},
    {ID_ADVENTURE_VISION, {ID_ADVENTURE_VISION, QStringLiteral("Adventure Vision"), QStringLiteral("Entex Adventure Vision"), QStringLiteral("Entex"), 2,
                           {QStringLiteral(".bin"), QStringLiteral(".rom")},
