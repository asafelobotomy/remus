...
{
    auto result = const_cast<PBPExporter*>(this)
                      ->runProcess(m_psxPackagerPath, QStringList() << "--version", 5000);
...
ConversionResult PBPExporter::exportToPBP(const QString &sourcePath,
