...
CREATE INDEX IF NOT EXISTS idx_game_disc_sets_game
    ON game_disc_sets(game_id);

CREATE INDEX IF NOT EXISTS idx_game_disc_sets_set_key
    ON game_disc_sets(set_key, disc_number);

CREATE INDEX IF NOT EXISTS idx_game_disc_tracks_disc
    ON game_disc_tracks(disc_set_id);
